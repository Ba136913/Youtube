...
// OMEGA-TOTAL RECONCILIATION VAULT V13
...
const SYMBOL_MAP: Record<string, string> = {
  ...
  "SUNPHARMA": "SUNPHARMA", "M&M": "M&M", "M_M": "M&M", "MARUTI": "MARUTI", "NTPC": "NTPC", "TITAN": "TITAN",
  ...
  "SIEMENS": "SIEMENS", "ABB": "ABBOTINDIA", "ABBOTINDIA": "ABBOTINDIA", "HAL": "HAL", "ZOMATO": "ZOMATO", "DLF": "DLF", "JIOFIN": "JIOFIN",
  ...
  "MOTILALOFS": "MOTILALOFS", "NAM_INDIA": "NAM_INDIA", "NAM-INDIA": "NAM_INDIA", "BSOFT": "BSOFT", "CYIENT": "CYIENT", "TATATECH": "TATATECH", 
  ...
  "UBL": "UBL", "UNITDSPR": "UNITDSPR", "MCDOWELL-N": "UNITDSPR", "GODFRYPHLP": "GODFRYPHLP", "EMAMILTD": "EMAMILTD",
  ...
  "BANDHANBNK": "BANDHANBNK", "RBLBANK": "RBLBANK", "SHREECEM": "SHREECEM", "HEIDELBERG": "HEIDELBERG", 
  "BANKINDIA": "BANKINDIA", "MANAPPURAM": "MANAPPURAM", "LTF": "LTF", "L&TFH": "LTF", "POONAWALLA": "POONAWALLA", 
  "LICHSGFIN": "LICHSGFIN", "CANFINHOME": "CANFINHOME", "360ONE": "360ONE", "KFINTECH": "KFINTECH", 
  "IBULHSGFIN": "IBULHSGFIN", "SAMMAN": "IBULHSGFIN", "LICI": "LICI", "LICINDIA": "LICI", "ICICIPRULI": "ICICIPRULI", 
  "ICICIGI": "ICICIGI", "STARHEALTH": "STARHEALTH", "HUDCO": "HUDCO", "IRFC": "IRFC", "GICRE": "GICRE", 
  "GIRE": "GICRE", "IDFC": "IDFC", "IFCI": "IFCI", "TATAPOWER": "TATAPOWER", "JSWENERGY": "JSWENERGY", 
  ...
  "MASTEK": "MASTEK", "SONATSOFTW": "SONATSOFTW", "ZENSARTECH": "ZENSARTECH", "GODREJCP": "GODREJCP", 
  ...
  "BOSCHLTD": "BOSCHLTD", "MOTHERSON": "MOTHERSON", "SONACOMS": "SONACOMS", "TIINDIA": "TIINDIA", 
  "EXIDEIND": "EXIDEIND", "ARE_M": "ARE_M", "BHARATFORG": "BHARATFORG", "SAMVARDHANA": "MOTHERSON", 
  "VEDL": "VEDL", "NATIONALUM": "NATIONALUM", "SAIL": "SAIL", "APLLTD": "APLLTD", "HINDZINC": "HINDZINC", 
  "ORIENTCEM": "ORIENTCEM", "SAGCEM": "SAGCEM", "MAHABANK": "MAHABANK", "IOB": "IOB", "UCOBANK": "UCOBANK", 
  "CENTRALBK": "CENTRALBK", "ERIS": "ERIS", "JBCHEPHARM": "JBCHEPHARM", "UPL": "UPL", "ATGL": "ATGL", "ADANIGAS": "ATGL"
};
...
async function syncTradingViewOmega() {
  ...
  try {
    ...
    // MAP BACK TO ALL KEYS (Fixes the duplication zero issue)
    const finalData: any = {};
