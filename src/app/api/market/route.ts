...
const SYMBOL_MAP: Record<string, string> = {
  ...
  "TECHM": "TECHM", "BRITANNIA": "BRITANNIA", "APOLLOHOSP": "APOLLOHOSP", "LTIM": "LTIM", "BAJAJ-AUTO": "BAJAJ_AUTO",
  ...
  "LUPIN": "LUPIN", "AUBANK": "AUBANK", "AUFB": "AUBANK", "IDFCFIRSTB": "IDFCFIRSTB", "KAYNES": "KAYNES", 
  ...
  "JYOTHYLAB": "JYOTHYLAB", "BALRAMCHIN": "BALRAMCHIN", "DALMIASUG": "DALMIASUG", "NHPC": "NHPC",
  ...
  "CITYUNIONBK": "CUB", "CUB": "CUB", "BANDHANBNK": "BANDHANBNK", "RBLBANK": "RBLBANK", "SHREECEM": "SHREECEM", 
  "HEIDELBERG": "HEIDELBERG", "BANKINDIA": "BANKINDIA", "MANAPPURAM": "MANAPPURAM", "LTF": "LTF", "POONAWALLA": "POONAWALLA", 
  "LICHSGFIN": "LICHSGFIN", "CANFINHOME": "CANFINHOME", "360ONE": "360ONE", "KFINTECH": "KFINTECH",
  "IBULHSGFIN": "IBULHSGFIN", "LICI": "LICI", "ICICIPRULI": "ICICIPRULI", "ICICIGI": "ICICIGI", "STARHEALTH": "STARHEALTH",
  "HUDCO": "HUDCO", "IRFC": "IRFC", "GICRE": "GICRE", "GIRE": "GICRE", "IDFC": "IDFC", "IFCI": "IFCI", "TATAPOWER": "TATAPOWER",
  "JSWENERGY": "JSWENERGY", "ADANIGREEN": "ADANIGREEN", "ADANIENSOL": "ADANIENSOL", "NLCINDIA": "NLCINDIA", "CESC": "CESC",
  "POWERINDIA": "POWERINDIA", "PREMIERENE": "PREMIERENE", "WAAREEENER": "WAAREEENER", "HPCL": "HINDPETRO", "ZYDUSLIFE": "ZYDUSLIFE",
  "AUROPHARMA": "AUROPHARMA", "ALKEM": "ALKEM", "BIOCON": "BIOCON", "IPCALAB": "IPCALAB", "LAURUSLABS": "LAURUSLABS",
  "GRANULES": "GRANULES", "PPLPHARMA": "PPLPHARMA", "MANKIND": "MANKIND", "ABBOTINDIA": "ABBOTINDIA", "ABBOTT": "ABBOTINDIA",
  "SYNGENE": "SYNGENE", "GLAND": "GLAND", "SANOFI": "SANOFI", "FORTIS": "FORTIS", "GLOBAL": "GLOBAL", "MEDANTA": "GLOBAL", "GULPOLY": "GULPOLY",
  "MASTEK": "MASTEK", "SONATSOFTW": "SONATSOFTW", "ZENSARTECH": "ZENSARTECH", "GODREJCP": "GODREJCP", "RADICO": "RADICO", "PVRINOX": "PVRINOX", "ASIANPAINT": "ASIANPAINT",
  "TVSMOTOR": "TVSMOTOR", "ASHOKLEY": "ASHOKLEY", "MRF": "MRF", "APOLLOTYRE": "APOLLOTYRE", "JKTYRE": "JKTYRE", "CEATLTD": "CEATLTD", "BOSCHLTD": "BOSCHLTD", "MOTHERSON": "MOTHERSON", "SONACOMS": "SONACOMS", "TIINDIA": "TIINDIA", "EXIDEIND": "EXIDEIND", "ARE_M": "ARE_M", "BHARATFORG": "BHARATFORG", "SAMVARDHANA": "MOTHERSON", "VEDL": "VEDL", "NATIONALUM": "NATIONALUM", "SAIL": "SAIL", "APLLTD": "APLLTD", "HINDZINC": "HINDZINC", "ORIENTCEM": "ORIENTCEM", "SAGCEM": "SAGCEM", "MAHABANK": "MAHABANK", "IOB": "IOB", "UCOBANK": "UCOBANK", "CENTRALBK": "CENTRALBK", "ERIS": "ERIS", "JBCHEPHARM": "JBCHEPHARM", "SOBHA": "SOBHA", "TATATECH": "TATATECH", "KPITTECH": "KPITTECH", "ADANIGAS": "ATGL", "ATGL": "ATGL", "UPL": "UPL", "ARE_M": "ARE_M", "BAJAJ_AUTO": "BAJAJ_AUTO"
};
...
async function syncTradingViewOmega() {
  ...
  try {
    ...
    json.data.forEach((item: any) => {
      ...
      const ourSym = Object.keys(SYMBOL_MAP).find(k => SYMBOL_MAP[k] === sym);
      if (ourSym && item.d[0] > 0) {
        data[ourSym] = {
          price: item.d[0],
          chgPct: item.d[1] || 0,
          open: item.d[2] || item.d[0],
