...
// OMEGA-TOTAL RECONCILIATION VAULT V14
...
const SYMBOL_MAP: Record<string, string> = {
  ...
  "MASTEK": "MASTEK", "SONATSOFTW": "SONATSOFTW", "SONATAW": "SONATSOFTW", "ZENSARTECH": "ZENSARTECH", 
  "GODREJCP": "GODREJCP", "RADICO": "RADICO", "PVRINOX": "PVRINOX", "ASIANPAINT": "ASIANPAINT", "TVSMOTOR": "TVSMOTOR", 
  ...
  if (Object.keys(persistentVault.tradingView).length === 0 || (now - vaultTimestamp) > GLOBAL_COOLDOWN) {
    if (!syncLock) {
      ...
      try {
        ...
        if (tv && Object.keys(tv).length > 50) {
